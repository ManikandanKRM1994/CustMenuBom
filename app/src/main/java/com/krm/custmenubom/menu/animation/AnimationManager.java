...
import static com.krm.custmenubom.menu.animation.BoomEnum.LINE;

public class AnimationManager {

    public static void animate(Object target, String property, long delay, long duration,
    ...
    public static void animate(Object target, String property, long delay, long duration,
        ...
        animate(target, property, delay, duration, evaluator, null, values);
    }
    ...
    public static Rotate3DAnimation getRotate3DAnimation(float[] xs, float[] ys, long delay,
        ...
        Rotate3DAnimation animation = new Rotate3DAnimation(bb.trueWidth() >> 1, bb.trueHeight() >> 1,
